    ...
    public class ComicBooksController : Controller
    {
        public ActionResult Detail()
        {
            ComicBook comicBook = new ComicBook()
            {
                ...
                IssueNumber = 700,
                DescriptionHtml = "<p>Final issue! Witness the final hour of Doctor Octopus' life and his one, last, great act of revenge! Even if Spider-Man survives...<strong>will Peter Parker?</strong></p>",
                Artists = new Artist[]
                {
